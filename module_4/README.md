## Задача проекта
Цель проекта - проаналищировать рейсы из Анапы в зимние месяцы 2017 года и отобрать убыточные или малоприбыльные полёты.
***
## Коротко о данных
В наборе данных присутствует 127 строк, 26 столбцов, 15 из которых используются в анализе, остальные являются вспомогательными из которых выведены другие столбцы.
***
